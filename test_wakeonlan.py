...
class TestSendMagicPacket(unittest.TestCase):
    ...
    def test_send_magic_packet(self, sock: mock.Mock) -> None:
        """
        Test whether the magic packets are broadcast to the specified network.
        ...
        self.assertEqual(
            ...
            [
                ...
                mock.call()
                .__enter__()
                .setsockopt(socket.SOL_SOCKET, socket.SO_BROADCAST, 128),
    ...
    @mock.patch('socket.socket')
    def test_send_magic_packet_with_ttl(self, sock: mock.Mock) -> None:
        """
        Test whether the magic packets are broadcast to the specified network with TTL set.

        """
        send_magic_packet(
            '133713371337', '00-00-00-00-00-00', ip_address='example.com', port=7, ttl=1
        )
        self.assertEqual(
            sock.mock_calls,
            [
    ...
    def test_send_magic_packet_default(self, sock: mock.Mock) -> None:
        """
        Test whether the magic packets are broadcast using default values.
    ...
    @mock.patch('socket.socket')
    def test_send_magic_packet_default_with_ttl(self, sock: mock.Mock) -> None:
        """
        Test whether the magic packets are broadcast using default values with TTL set.

        """
        send_magic_packet('133713371337', '00-00-00-00-00-00', ttl=1)
        self.assertEqual(
            sock.mock_calls,
            [
                mock.call(socket.AF_INET, socket.SOCK_DGRAM),
    ...
    def test_send_magic_packet_interface(self, sock: mock.Mock) -> None:
        """
        Test whether the magic packets are broadcast to the specified network via specified interface.
    ...
    @mock.patch('socket.socket')
    def test_send_magic_packet_interface_with_ttl(self, sock: mock.Mock) -> None:
        """
        Test whether the magic packets are broadcast to the specified network via specified interface with TTL set.
    ...
    @mock.patch('socket.socket')
    def test_send_correct_af_chosen_with_ipv6_address_with_ttl(self, sock: mock.Mock) -> None:
        """
        Test whether AF_INET6 automatically chosen when the `address_family` argument is not given with TTL set.
        """
        send_magic_packet(
            '133713371337',
            '00-00-00-00-00-00',
    ...
    @mock.patch('socket.socket')
    def test_send_with_explicit_ipv6_address_with_ttl(self, sock: mock.Mock) -> None:
        """
        Test whether the given address family is used instead automatically it automatically with TTL set.
        """
        send_magic_packet(
            '133713371337',
            '00-00-00-00-00-00',
...
class TestMain(unittest.TestCase):
    ...
    def test_main(self, send_magic_packet: mock.Mock) -> None:
        ...
        main(['00:11:22:33:44:55', '-i', 'host.example', '-p', '1337', '-t', '1'])
        self.assertEqual(
